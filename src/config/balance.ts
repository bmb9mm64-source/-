...
export const BALANCE = {
  ...
  BGM: {
    ...
    TRACKS: {
      title: {
        // 穏やかで明るいポップ。C → G → Am → F（王道の I–V–vi–IV）
        TEMPO: 92,
        SWING: 0.14,
        PROG: [
        ...
        FORM: [0, 1, 0, 2],
        BASS: [0, -99, -99, 0, 7, -99, -99, -99],
        DRUMS: null, // ドラムなし（静かな曲）
        ARP: true,
      },
      game: {
        // プレイ中は緊張感を優先する（v0.21.1）。使う音は C メジャーのままだが、
        // **主役の和音を A マイナー（Am＝C メジャーの平行短調）に移す**＝
        // 音階外の音を一切足さずに（＝不気味にならずに）張り詰めた響きになる。
        // 進行は Am → F → G → Am。最後にまた Am へ戻るので解決しきらず、緊張が続く。
        TEMPO: 126,
        SWING: 0, // スウィングは「ゆとり」を生む。プレイ中は等間隔のまま緊迫させる
        PROG: [
          { ROOT: 0, TONES: [0, 3, 7, 12] }, // Am
          { ROOT: -4, TONES: [0, 4, 7, 12] }, // F
          { ROOT: -2, TONES: [0, 4, 7, 12] }, // G
        ...
        PHRASES: [
          // A（主題）：同じ音を刻んで食い下がる（音を動かさないことで張り詰める）
          [
            24, -98, 24, 24, -98, 22, 24, -98,
            26, -98, 24, -98, 22, -98, 20, -98,
            22, -98, 22, 24, -98, 26, -98, -98,
            24, -98, -98, -98, -99, -99, 19, -98,
          ],
          // B（切迫）：高音域で細かく動き、最後に長く伸ばして息を詰める
          [
            31, -98, 29, -98, 27, -98, 26, -98,
            27, -98, 26, 27, -98, 29, -98, -98,
            26, -98, 24, -98, 22, -98, 26, -98,
            24, -98, -98, -98, -98, -99, -99, -99,
          ],
          // C（結び）：駆け上がって主音 A の**第5音 E** で止める＝解決しないまま次の周へ
          [
            24, 26, 27, -98, 26, -98, 24, -98,
            22, 24, 26, -98, 24, -98, 22, -98,
            26, -98, 27, -98, 29, -98, 31, -98,
            31, -98, -98, -98, -98, -98, -98, -98,
          ],
        ],
        FORM: [0, 1, 0, 2],
        BASS: [0, 0, -99, 0, 0, -99, 0, 0], // 根音を刻み続ける（心拍のような一定の圧）
        DRUMS: {
          KICK: [0, 3, 4], // 3拍目裏に食い込ませて前のめりにする
          SNARE: [2, 6], // 裏拍のバックビート
        },
        ARP: true,
      },
