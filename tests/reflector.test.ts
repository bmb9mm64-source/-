...
describe("リフレクターAI（ステートマシン。GDD §6 v0.9）", () => {
  ...
  it("同時発射数上限は2発：自弾2発が場にある間は撃たず、1発なら撃てる", () => {
    ...
    const own1: Bullet = { x: 400, y: 400, vx: 0, vy: 0, radius: 4, bounces: 0, owner: e, dead: false };
    const own2: Bullet = { x: 420, y: 400, vx: 0, vy: 0, radius: 4, bounces: 0, owner: e, dead: false };
